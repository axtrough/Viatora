...
public class VRecipes extends RecipeProvider implements IConditionBuilder {
    public VRecipes(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pRegistries) {
